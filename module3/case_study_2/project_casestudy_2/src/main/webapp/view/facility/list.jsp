...
<div class="vh-100">
    ...
    <div>
        <div class="row text-center align-items-center" style="border-bottom: 2px black solid">
            ...
            <div class="col-1">
                <button type="button" class="btn btn-outline-success">
                    <a style="text-decoration: none; color: #198754" href="/facility?action=add&facilityType=Villa">+ villa</a>
                </button>
            </div>
            <div class="col-1">
                <button type="button" class="btn btn-outline-success">
                    <a style="text-decoration: none; color: #198754" href="/facility?action=add&facilityType=House">+ home</a>
                </button>
            </div>
            <div class="col-1">
                <button type="button" class="btn btn-outline-success">
                    <a style="text-decoration: none; color: #198754" href="/facility?action=add&facilityType=Room">+ room</a>
                </button>
            </div>
        </div>
