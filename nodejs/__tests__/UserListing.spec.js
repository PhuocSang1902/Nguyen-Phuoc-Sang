...
describe('Listing Users', () => {
  ...
  it('returns user page without logged in user wher request has valid authorization', async () => {
    await addUsers(11);
    const response = await getUsers({ auth: { email: 'user1@gmail.com', password: 'Password1' } }).query({
      size: 'size',
      page: 'page',
    });
