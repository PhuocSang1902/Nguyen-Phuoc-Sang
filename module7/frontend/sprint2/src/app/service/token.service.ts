...
const ID_CUSTOMER_KEY = 'IdCustomer_key';
...
export class TokenService {
  ...
  public setIdCustomer(idCustomer: string): void {
    sessionStorage.removeItem(ID_CUSTOMER_KEY);
    sessionStorage.setItem(ID_CUSTOMER_KEY, idCustomer);
  }

  public getIdCustomer(): string | null {
    return sessionStorage.getItem(ID_CUSTOMER_KEY);
  }
